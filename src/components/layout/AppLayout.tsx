...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Documentos', href: '/documentos', icon: DocumentTextIcon, current: true },
    { name: 'Não Conformidades', href: '/nao-conformidades', icon: ExclamationTriangleIcon, current: false },
    { name: 'Ensaios', href: '/ensaios', icon: BeakerIcon, current: false },
    { name: 'Auditorias', href: '/auditorias', icon: ClipboardDocumentCheckIcon, current: false },
    { name: 'Equipe', href: '/equipe', icon: UserGroupIcon, current: false },
